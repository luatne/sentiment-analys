...
Do model khá nặng nên không để lên github nổi
4. Khởi chạy Ứng dụng
Sau khi cài đặt xong, bạn cần đảm bảo tất cả các file mã nguồn và tài nguyên (app.py, sentiment.py, preprocess.py, database.py, teencode.txt, và file trọng số mô hình checkpoint.pth) nằm trong cùng một thư mục.
